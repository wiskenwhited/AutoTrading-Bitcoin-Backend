...
return [
    ...
    */
    ...
    'api_key' => env('BUGSNAG_API_KEY', 'fbfa6b754ca73f7c2ce3caec95ded70c'),
    ...
    */
    ...
    'notify_release_stages' => empty(env('BUGSNAG_NOTIFY_RELEASE_STAGES', 'staging,production')) ? null : explode(',', str_replace(' ', '', env('BUGSNAG_NOTIFY_RELEASE_STAGES', 'staging,production'))),
